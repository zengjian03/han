...
async function home(filter) {
    let classes = [{"type_id":1,"type_name":"电影"},{"type_id":2,"type_name":"追剧"},{"type_id":3,"type_name":"综艺"},{"type_id":4,"type_name":"动漫"},{"type_id":36,"type_name":"体育"}];
    let filterObj = {
		"2":[{"key":"cateId","name":"类型","value":[{"n":"全部","v":"2"},{"n":"短剧","v":"46"},{"n":"陆剧","v":"13"},{"n":"韩剧","v":"15"},{"n":"欧美剧","v":"16"},{"n":"港剧","v":"14"},{"n":"台剧","v":"21"},{"n":"日剧","v":"22"},{"n":"海外剧","v":"23"},{"n":"泰剧","v":"24"},{"n":"纪录片","v":"20"}]}],
		"1":[{"key":"cateId","name":"类型","value":[{"n":"全部","v":"1"},{"n":"动作片","v":"6"},{"n":"喜剧片","v":"7"},{"n":"爱情片","v":"8"},{"n":"科幻片","v":"9"},{"n":"恐怖片","v":"10"},{"n":"剧情片","v":"11"},{"n":"战争片","v":"12"},{"n":"电影解说","v":"35"}]}],
	    ...
	    "36":[{"key":"cateId","name":"类型","value":[{"n":"全部","v":"36"},{"n":"足球","v":"37"},{"n":"篮球","v":"38"},{"n":"网球","v":"39"},{"n":"斯诺克","v":"40"}]}]
	};
...
async function detail(id) {
    ...
    var vod = {
     ...
     const playlist = _.map($('div.lzm3u8 > li > a[target*=_blank]'), (it) => {
        return it.attribs.title + '$' + it.attribs.href;
    });
    vod.vod_play_from = "量子直达";

...
let key = '';
let HOST = 'https://ht158rr.com:9527/';
let siteKey = '';
let siteType = 0;
...
async function home(filter) {
    let classes = [{"type_id":'guochan',"type_name":"国产"},{"type_id":'chuangmei',"type_name":"蓝光无修"},{"type_id":'guochan',"type_name":"动漫剧场"},{"type_id":'guochan',"type_name":"欧美动漫"}];
    let filterObj = {
        ...
        "4":[{"key":"year","name":"年份","value":[{"n":"全部","v":""},{"n":"42","v":"42"},{"n":"2022","v":"2022"},{"n":"2021","v":"2021"},{"n":"2020","v":"2020"},{"n":"2019","v":"2019"},{"n":"2018","v":"2018"},{"n":"2017","v":"2017"},{"n":"2016","v":"2016"},{"n":"2015","v":"2015"},{"n":"2014","v":"2014"},{"n":"2013","v":"2013"},{"n":"2012","v":"2012"},{"n":"2011","v":"2011"},{"n":"2010","v":"2010"},{"n":"2009","v":"2009"},{"n":"2008","v":"2008"},{"n":"2007","v":"2007"},{"n":"2006","v":"2006"},{"n":"2005","v":"2005"},{"n":"2004","v":"2004"},{"n":"2003","v":"2003"},{"n":"2002","v":"2002"},{"n":"2001","v":"2001"},{"n":"2000","v":"2000"}]},{"key":"by","name":"排序","value":[{"n":"最新","v":"/by/time"},{"n":"最热","v":"/by/hits"},{"n":"评分","v":"/by/score"}]}]
	};
...
async function category(tid, pg, filter, extend) {
    if (pg <= 0) pg = 1;
    const link = HOST + 'type/' + tid + '/' + (extend.year || '-') + (extend.by || '-') + '-' + pg;
    //https://ht28ss.xyz:9527/type/guochan/42-%E5%9B%BD%E4%BA%A7-hits-1
    //https://ht28ss.xyz//type/guochan/----1
   const html = await request(link);
    const $ = load(html);
    const items = $('div.list-grid > div.vod-item');
    let videos = _.map(items, (item) => {
        const it = $(item).find('a:first')[0];
        const remarks = $($(item).find('i.zicon zicon-eye')[0]).text().trim();
        return {
            vod_id: it.attribs.href.replace(/\/vod\/(.*).html/g,, '$1'),
            vod_name: it.attribs['span.vod-title'],
            vod_pic: it.attribs.img,
            vod_remarks: remarks || '',
        };
    });
    const hasMore = $('div.pagination > a.pagination-next:contains(下頁)').length > 0;
